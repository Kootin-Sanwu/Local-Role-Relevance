      ...
      <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-5">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            <h2>Job Role Evaluation System</h2>
            <p>Empowering both individuals and organizations to assess job roles effortlessly. Our system leverages real-time data and predictive analytics to help make informed choices about workforce planning.</p>
            
            <p>Let’s streamline the way you understand and maximize the value of each role within your organization.</p>
            <div class="d-flex">
          ...
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="img/hero-img-3.png" class="img-fluid" alt="">
          </div>
        </div>
      </div>
          ...
          <div class="row gy-4 mt-5">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="icon-box position-relative">
                ...
                <h4 class="title"><a href="views/login.php" class="stretched-link">Organization</a></h4>
              </div>
            </div><!--End Icon Box -->
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            ...
            <p class="fst-bold">
              Unlock each role's potential with data-driven insights tailored to industry demands, empowering strategic decisions that align talent with your organization’s goals.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Gain real-time insights into the relevance of each job role within your organization.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Make data-driven decisions to optimize workforce planning, strategic hiring and resource management.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Customize evaluation metrics based on industry trends, skill demand, and market salaries for a tailored analysis.</span></li>
            </ul>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              ...
              <a href="service-details.html" class="stretched-link">
                <h3>Real-time Role Relevance Analyses</h3>
              </a>
              <p>
                Provides up-to-date relevance scores for each job role based on industry trends, 
                skill requirements, and market demands, enabling organizations to assess the current value of roles within the company.
              </p>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <a href="service-details.html" class="stretched-link">
                <h3>Predictive Job Role Forecasting</h3>
              </a>
              <p>
                Uses machine learning to forecast the future demand and relevance of specific job roles,
                 helping organizations plan for emerging trends and prepare for potential shifts in workforce needs.
              </p>
            </div>
          </div>
          <!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item position-relative">
              ...
              <a href="service-details.html" class="stretched-link">
                <h3>Customizable Role Metrics</h3>
              </a>
              <p>
                Allows HR professionals to adjust evaluation metrics (like skill demand, salary trends, and geographic demand) to align with specific organizational goals,
                 industry standards, and strategic priorities.
              </p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <a href="service-details.html" class="stretched-link">
                <h3>Role Comparison and Benchmarking</h3>
              </a>
              <p>
                Facilitates side-by-side comparisons of various job roles, 
                making it easier for HR teams to understand and evaluate the comparative importance of different roles within the organization.
              </p>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="service-item position-relative">
              ...
              <a href="service-details.html" class="stretched-link">
                <h3>Automated Reporting and Visualization</h3>
              </a>
              <p>
                Generates detailed, customizable reports with data visualizations to support HR decisions on hiring,
                 promotions, and restructuring, with multiple export options.
              </p>
              <a href="service-details.html" class="stretched-link"></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <a href="service-details.html" class="stretched-link">
                <h3>Trend Monitoring and Alerts</h3>
              </a>
              <p>
                Monitors industry shifts and skill trends, 
                sending alerts for significant changes that could affect job roles within the organization, 
                so HR teams stay informed of emerging opportunities and challenges in real time
              </p>
              <a href="service-details.html" class="stretched-link"></a>
            </div>
          </div><!-- End Service Item -->
      ...
      <div class="container">
        ...
        <div class="row gy-5 justify-content-between">
          ...
          <div class="col-xl-5" data-aos="zoom-out" data-aos-delay="100">
            ...
            <!-- <img src="img/transparent-4.png" class="img-fluid" alt=""> -->
          </div>
  ...
  <footer id="footer" class="footer light-background">
    ...
    <div class="container">
      <div class="copyright text-center ">
        <p>© <span>Copyright</span> <strong class="px-1 sitename">Job Role Evaluation</strong> <span>All Rights Reserved</span></p>
      </div>
